...
public class Perspectiva {
    ...
    private final JPanel diagrama;
    private final JPanel codigos;
    private final JSplitPane diagramaSplitCode;
    private final JSplitPane splitCodigos;
    private final JSplitPane infoSplitMapa;
    private final JSplitPane programmerSplit;
    private final JTabbedPane infoPanel;
    private byte modo;
