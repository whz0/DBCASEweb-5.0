...
public class MyMenu extends JMenuBar {
    ...
    private final JMenuItem submenuNuevo;
    private final JMenuItem submenuAbrir;
    private final JMenuItem submenuGuardar;
    private final JMenuItem submenuGuardarComo;
    private final AbstractButton submenuImprimir;
    private final AbstractButton submenuExportarJPEG;
    private final AbstractButton submenuSalir;
    private final AbstractButton menuOpciones;
    private final JMenu menuLenguajes;
    private final Vector<JRadioButtonMenuItem> elementosMenuLenguajes;
    private final JRadioButtonMenuItem nullAttr;
