...
public class Lenguaje {
    ...
    // Mensaje por defecto
    private static final String notExistingMessage = "Asked message does not exist";
    ...
    public static String text(int tipoMensaje) {
        ...
        switch (tipoMensaje) {
            case DBCASE:
                texto = _textos.get("dbcase");
                break;
            case SELECT:
                texto = _textos.get("select");
                break;
            case YES:
                texto = _textos.get("yes");
                break;
            case NO:
                texto = _textos.get("no");
                break;
            case CANCEL:
                texto = _textos.get("cancel");
                break;
            case INSERT:
                texto = _textos.get("insert");
                break;
            case INFO:
                texto = _textos.get("info");
                break;
            case ERROR:
                texto = _textos.get("error");
                break;
            case SUCCESS:
                texto = _textos.get("success");
                break;
            case WARNING:
                texto = _textos.get("warning");
                break;
            case WISH_CONTINUE:
                texto = _textos.get("wishContinue");
                break;
            case EXIT:
                texto = _textos.get("exit");
                break;
            case EXECUTE:
                texto = _textos.get("execute");
                break;
            case EDIT:
                texto = _textos.get("edit");
                break;
            case REMOVE:
                texto = _textos.get("remove");
                break;
            case ENTITY:
                texto = _textos.get("entity");
                break;//"Entidad"
            case RELATION:
                texto = _textos.get("relation");
                break;//"Relación"
            case ATTRIBUTE:
                texto = _textos.get("attribute");
                break;//"Atributo"
            case ISA_RELATION:
                texto = _textos.get("isaRelation");
                break;//"Relación IsA"
            case ENTITIES:
                texto = _textos.get("entities");
                break;//"Entidades"
            case CARDINALITY:
                texto = _textos.get("cardinality");
                break;//"Cardinalidad"
            case ATTRIBUTES:
                texto = _textos.get("attributes");
                break;//"Atributos"
            case COMPOSED:
                texto = _textos.get("composed");
                break;//"Compuesto"
            case DOMAIN:
                texto = _textos.get("domain");
                break;//"Dominio"
            case PRIMARY_KEYS:
                texto = _textos.get("primaryKeys");
                break;//"Claves primarias"
            case DELETE:
                texto = _textos.get("delete");
                break;//"Eliminar"
            case RENAME:
                texto = _textos.get("rename");
                break;//Renombrar
            case NEW:
                texto = _textos.get("new");
                break;
            case OPEN:
                texto = _textos.get("open");
                break;
            case CLOSE:
                texto = _textos.get("close");
                break;
            case SAVE:
                texto = _textos.get("save");
                break;
            case SAVE_AS:
                texto = _textos.get("saveAs");
                break;
            case NAME:
                texto = _textos.get("name");
                break;// NAME = 42;
            case TYPE:
                texto = _textos.get("type");
                break;//public static final int TYPE = 43;
            case VALUES:
                texto = _textos.get("values");
                break;//public static final int VALUES = 44;
            case ACCEPT:
                texto = _textos.get("accept");
                break;
            case NEW2:
                texto = _textos.get("new2");
                break;

            case SELECT_WORKSPACE:
                texto = _textos.get("selectWorkspace");
                break;
            case ERROR_CREATING_FILE:
                texto = _textos.get("errorCreatingFile");
                break;

            case ERROR_TEMP_FILE:
                texto = _textos.get("errorTempFile");
                break;//No se ha podido crear el fichero temporal
            case WRONG_FILE:
                texto = _textos.get("wrongFile");
                break;//El fichero seleccionado no es de esta aplicación
            case NOT_EXIST_FILE:
                texto = _textos.get("notExistFile");
                break;//El fichero no existe

            case WORKSPACE_IS:
                texto = _textos.get("workspaceIs");
                break;//El directorio actual de trabajo es:
            case INITIAL_ERROR:
                texto = _textos.get("initialError");
                break;//Se ha producido un error en la creacion inicial
            case OF_XMLFILES:
                texto = _textos.get("ofXMLfiles");
                break;//de los ficheros XML en el directorio de trabajo:
            case DELETE_ENTITY:
                texto = _textos.get("deleteEntity");
                break;//DBDT: Eliminar entidad
            case DELETE_ATTRIBUTE:
                texto = _textos.get("deleteAttribute");
                break;//DBDT: Eliminar atributo
            case DELETE_DOMAIN:
                texto = _textos.get("deleteDomain");
                break;//DBDT: Eliminar dominio
            case ADD_ENTITY_RELATION:
                texto = _textos.get("addEntityRelation");
                break;//DBDT: Añadir una entidad a la relación
            case DELETE_ISA_RELATION:
                texto = _textos.get("deleteIsaRelation");
                break;//DBDT: Eliminar relación IsA
            case DELETE_RELATION:
                texto = _textos.get("deleteRelation");
                break;//DBDT: Eliminar relación
            case DELETE_ATTRIBUTES_WARNING:
                texto = _textos.get("deleteAttributes");
                break;
            case REMOVE_FROM_SYSTEM:
                texto = _textos.get("removeFromSystem");
                break;
            case THE_ATTRIBUTE:
                texto = _textos.get("attribute");
                break;
            case WEAK_RELATION:
                texto = _textos.get("weakRelation");
                break;
            case DELETE_ATTRIBUTES_WARNING2:
                texto = _textos.get("deleteAttributes2");
                break;
            case MODIFYING_CARDINALITY:
                texto = _textos.get("modifyingCardinality");
                break;
            case MODIFY_ATTRIBUTE:
                texto = _textos.get("modifyAttribute");
                break;
            case DELETE_ATTRIBUTES_WARNING3:
                texto = _textos.get("deleteAttributes3");
                break;
            case ISA_RELATION_DELETE:
                texto = _textos.get("deleteIsaRelation");
                break;
            case MODIFYING_ATTRIBUTES_WARNING4:
                texto = _textos.get("modifyingAttributesWarning");
                break;
            case RELATION_WEAK_ENTITIES:
                texto = _textos.get("relationWeakEntities");
                break;
            case NO_ATTRIBUTES_RELATION:
                texto = _textos.get("noAttributesRelation");
                break;
            case ALREADY_WEAK_ENTITY:
                texto = _textos.get("alreadyWeakEntity");
                break;
            case IS_WEAK:
                texto = _textos.get("isWeak");
                break;
            case INCORRECT_VALUE:
                texto = _textos.get("incorrectValue");
                break;
            case ENTITIES_FILE_ERROR:
                texto = _textos.get("entitiesFileError");
                break;//Se ha producido un error en el acceso al fichero de entidades.
            case RELATIONS_FILE_ERROR:
                texto = _textos.get("relationsFileError");
                break;//Se ha producido un error en el acceso al fichero de relaciones.
            case ATTRIBUTES_FILE_ERROR:
                texto = _textos.get("attributesFileError");
                break;//Se ha producido un error en el acceso al fichero de atributos.
            case DOMAINS_FILE_ERROR:
                texto = _textos.get("domainsFileError");
                break;//Se ha producido un error en el acceso al fichero de dominios.
            case EMPTY_ATTRIB_NAME:
                texto = _textos.get("emptyAttribName");
                break;//El nombre del atriburo es vacío.
            case EMPTY_DOM_NAME:
                texto = _textos.get("emptyDomName");
                break;//El nombre del dominio es vacío.
            case EMPTY_ENT_NAME:
                texto = _textos.get("emptyEntName");
                break;//El nombre de la entidad es vacío.
            case EMPTY_REL_NAME:
                texto = _textos.get("emptyRelName");
                break;//El nombre de la relación es vacío.
            case EMPTY_SUBATTR_NAME:
                texto = _textos.get("emptySubattribName");
                break;//El nombre del subatributo es vacío.
            case EMPTY_TYPE_NAME:
                texto = _textos.get("emptyTypeName");
                break;//El nuevo tipo es vacío.
            case EMPTY_VALUES:
                texto = _textos.get("emptyValues");
                break;//El campo 'valores' es vacío.
            case REPEATED_ENT_NAME:
                texto = _textos.get("repeatedEntName");
                break;//Existe una entidad en el sistema con el mismo nombre.
            case REPEATED_ATTRIB_NAME:
                texto = _textos.get("repeatedAttribName");
                break;//Ya existe un atributo con ese nombre en la entidad.
            case REPEATED_ATTRIB_NAME_REL:
                texto = _textos.get("repeatedAttribNameRel");
                break;//Ya existe un atributo en la relación con ese nombre.
            case REPEATED_REL_NAME:
                texto = _textos.get("repeatedRelName");
                break;//Existe una relación en el sistema con el mismo nombre.
            case REPEATED_ROL_NAME:
                texto = _textos.get("repeatedRolName");
                break;//Existe otro rol en la relación con el mismo nombre.
            case REPEATED_SUBATR_NAME:
                texto = _textos.get("repeatedSubatrName");
                break;//Existe otro subatributo con ese nombre.
            case REPEATED_DOM_NAME:
                texto = _textos.get("repeatedDomName");
                break;//Existe otro dominio en el sistema con el mismo nombre.
            case INCORRECT_SIZE1:
                texto = _textos.get("incorrectSize1");
                break;//El tamano del dominio del atributo no es un valor entero positivo.
            case INCORRECT_SIZE2:
                texto = _textos.get("incorrectSize2");
                break;//El tamano del dominio del atributo es nulo o negativo.
            case INCORRECT_SIZE3:
                texto = _textos.get("incorrectSize3");
                break;//El tamaño del atributo no es un valor entero positivo.
            case INCORRECT_CARDINALITY1:
                texto = _textos.get("incorrectCardinality1");
                break;//El valor de inicio no es un número entero positivo o 'n'.
            case INCORRECT_CARDINALITY2:
                texto = _textos.get("incorrectCardinality2");
                break;//El valor de inicio es un número negativo.
            case INCORRECT_CARDINALITY3:
                texto = _textos.get("incorrectCardinality3");
                break;//El valor de fin no es un número entero positivo o 'n'.
            case INCORRECT_CARDINALITY4:
                texto = _textos.get("incorrectCardinality4");
                break;//El valor de fin es un número negativo.
            case INCORRECT_CARDINALITY5:
                texto = _textos.get("incorrectCardinality5");
                break;//El valor de inicio es mayor que el de fin.
            case NECESARY_ROL:
                texto = _textos.get("necesaryRol");
                break;//Debe asignar un rol a la entidad.
            //case SUCCESS_SAVE: texto = _textos.get("successFile"); break;
            case WISH_SAVE:
                texto = _textos.get("wishSave");
                break;
            case IF_WEAK_ENTITY:
                texto = _textos.get("weakEntity");
                break;
            case WARNING_DELETE_WEAK_ENTITY:
                texto = _textos.get("warningDeleteWeakEntity");
                break;
            case WARNING_DELETE_WEAK_RELATION:
                texto = _textos.get("warningDeleteWeakRelation");
                break;
            case REPEATED_ENTITY_REL:
                texto = _textos.get("repeatedEntyRel");
                break;
            //SERVICIOS
            case EMPTY_VALUE:
                texto = _textos.get("emptyValue");
                break;//"Uno de los valores es vacío."
            case INCORRECT_NUMBER:
                texto = _textos.get("incorrectNumber");
                break;//"Uno de los valores no es correcto. Introduzca valores numéricos enteros"
            case INCORRECT_VALUE_EX:
                texto = _textos.get("incorrectValueEx");
                break;//"Uno de los valores no es correcto. Ejemplos:"
            case INCORRECT_BIT_VALUE:
                texto = _textos.get("incorrectBitValue");
                break;//"Uno de los valores no es correcto. Los únicos valores aceptables son 0 y 1"
            case QUOTATION_MARKS:
                texto = _textos.get("quotationMarks");
                break;//"Introduzca los valores entre comillas simples"
            case INCORRECT_DATE:
                texto = _textos.get("incorrectDate");
                break;//"Uno de los valores no es correcto. Introduzca valores de la forma 'aaaammdd'"
            //SERVICIOS SISTEMA
            case RATIFYING:
                texto = _textos.get("ratifying");
                break;//"Validando "
            case RATIFYING_ATTRIB_DOMAIN:
                texto = _textos.get("ratifyinAttribDomain");
                break;//"Validando el dominio del atributo"
            case COMPOSED_ATTRIBUTE:
                texto = _textos.get("composedAttribute");
                break;//"El atributo es compuesto y no puede tener dominio."
            case CORRECT_DOMAIN:
                texto = _textos.get("correctDomain");
                break;//"El dominio del atributo es correcto."
            case NO_DOMAIN:
                texto = _textos.get("noDomain");
                break;//"El atributo no tiene dominio."
            case UNKNOWN_DOMAIN:
                texto = _textos.get("unkownDomain");
                break;//"El dominio del atributo no esta en el sistema."
            case RATIFYING_ATTRIBUTE:
                texto = _textos.get("ratifyingAttribute");
                break;//"Validando la exclusividad del atributo"
            case ONE_ATTRIB_SUBATTRIB:
                texto = _textos.get("oneAttribSubattrib");
                break;//" es subatributo de un solo atributo."
            case MANY_ATTRIB_SUBATTRIB:
                texto = _textos.get("manyAttribSubattrib");
                break;//" es subAtributo de más de un atributo."
            case ONE_ENTITY:
                texto = _textos.get("oneEntity");
                break;//" pertenece a una sola entidad."
            case MANY_ENTITIES:
                texto = _textos.get("manyEntities");
                break;//" pertenece a más de una entidad."
            case RATIFYING_CHILDREN:
                texto = _textos.get("ratifyingChildren");
                break;//"Validando hijos atributo compuesto."
            case NO_SUBATTRIB:
                texto = _textos.get("noSubattrib");
                break;//"El atributo no tiene subatributos."
            case ONE_SUBATTRIB:
                texto = _textos.get("oneSubattrib");
                break;//"El atributo solo tiene un subatributo."
            case RATIFYING_PRIMARYKEYS:
                texto = _textos.get("ratifyingPrimaryKeys");
                break;//"Validando claves primarias de la entidad."
            case NOKEY_WEAK_ENTITY:
                texto = _textos.get("noKeyWeakEntity");
                break;//"La entidad es debil y carece de atributo discriminante (poner clave primaria)."
            case NOKEY_ENTITY_RELATION:
                texto = _textos.get("noKeyEntRel");
                break;//"La entidad está vinculada a una relación y no tiene clave primaria."
            case ALL_CHILDREN_KEYS:
                texto = _textos.get("allChildrenKey");
                break;//" El atributo es compuesto y todas sus hojas son claves. También se puede señalar como clave al atributo padre."
            case NO_ATTRIB_KEY:
                texto = _textos.get("noAttribKey");
                break;//	" La o las claves de la entidad no forman parte de sus atributos."
            case MULTIVALUE_KEY:
                texto = _textos.get("multivalueKey");
                break;//	" es multivalorado y no puede ser clave."
            case ISA_PARENT:
                texto = _textos.get("isaParent");
                break;//	" La entidad es una hija en una relacion IsA, puede heredar la clave."
            case NO_PRIMARY_KEY:
                texto = _textos.get("noPrimaryKey");
                break;//	" La entidad no tiene clave primaria."
            case CORRECT_KEYS:
                texto = _textos.get("correctKeys");
                break;//	" Las claves de la entidad son correctas."
            case RATIFYING_ATTRIB_NAMES:
                texto = _textos.get("ratifyingAttribNames");
                break;//	"Validando nombres de los atributos de la entidad"
            case NO_ATTRIB:
                texto = _textos.get("noAttrib");
                break;//	" no tiene atributos."
            case ATTRIB_NAME:
                texto = _textos.get("attribName");
                break;//	" El nombre del atributo "
            case IS_REPEATED_IN_ENTITY:
                texto = _textos.get("isRepeatedInEnt");
                break;//	" está repetido en la entidad "
            case ATTRIB_NAMES:
                texto = _textos.get("attribNames");
                break;//	" Los nombres de los atributos de la entidad "
            case ARE_CORRECT:
                texto = _textos.get("areCorrect");
                break;//	" son correctos."
            case ENT_PARENT_IN:
                texto = _textos.get("entParentIn");
                break;//	" La entidad es padre en "
            case ISA_RELATIONS:
                texto = _textos.get("isaRelations");
                break;//	" relaciones IsA"
            case NO_WEAK_ENT_RELAT:
                texto = _textos.get("noWeakEntRel");
                break;//	" Esta relación no puede tener entidades debiles."
            case NO_PARENT_REL:
                texto = _textos.get("noParentRel");
                break;//	" La relación carece de padre."
            case NO_CHILD_RELATION:
                texto = _textos.get("noChildRel");
                break;//	" La relación necesita al menos un hijo."
            case OK_RELATION:
                texto = _textos.get("okRelation");
                break;//	" La relación tiene padre y al menos un hijo."
            case IS_NORMAL_TYPE:
                texto = _textos.get("isNormalType");
                break;//	" es de tipo Normal"
            case NO_ENT_RELATION:
                texto = _textos.get("noEntRelation");
                break;//	" La relación carece de entidades."
            case ONE_ENT_REL:
                texto = _textos.get("oneEntRel");
                break;//" La relación sólo relaciona una entidad."
            case MANY_ENT_REL:
                texto = _textos.get("manyEntRel");
                break;//" La relación asocia dos o más entidades."
            case IS_WEAK_TYPE:
                texto = _textos.get("isWeakType");
                break;//	" es de tipo Débil"
            case ONE_ENT_WEAK_REL:
                texto = _textos.get("oneEntWeakRel");
                break;//	"La relación es débil y necesita mas de una entidad."
            case NO_WEAK_ENT_REL:
                texto = _textos.get("noWeakEntRel");
                break;//	" La relación no posee ninguna entidad débil."
            case MANY_WEAK_ENT_REL:
                texto = _textos.get("manyWeakEntRel");
                break;//	" La relación sólo puede tener una entidad débil."
            case NO_STRONG_ENT_REL:
                texto = _textos.get("noStrongEntRel");
                break;//	" La relación no posee ninguna entidad fuerte."
            case OK_ENT_REL:
                texto = _textos.get("okEntRel");
                break;//	" La relación posee las entidades adecuadas."

            case RATIFYING_DOMAIN:
                texto = _textos.get("ratifyingDomain");
                break;//	"Validando la unicidad del dominio"
            case REPEATED_DOM_NAMES:
                texto = _textos.get("repeatedDomNames");
                break;//	"Hay varios dominios con el mismo nombre."
            case OK_DOMAIN:
                texto = _textos.get("okDomain");
                break;//"El dominio es único."
            case RATIFYING_DOMAIN_VALUES:
                texto = _textos.get("ratifyingDomainValues");
                break;//"Validando valores del dominio"
            case NO_VALUE_DOM:
                texto = _textos.get("noValueDom");
                break;//"El dominio no tiene ningún valor."
            case THE_VALUE:
                texto = _textos.get("theValue");
                break;//"El valor "
            case IS_REPEATED:
                texto = _textos.get("isRepeated");
                break;//" está indicado varias veces."
            case OK_DOM_VALUES:
                texto = _textos.get("okDomValues");
                break;//"Los valores del dominio no se repiten."
            case RATIFYING_DOM_USE:
                texto = _textos.get("ratifyingDomUse");
                break;//"Validando uso del dominio"
            case USE_DOM:
                texto = _textos.get("useDom");
                break;//"El dominio está usado en el diseño."
            case NO_USE_DOM:
                texto = _textos.get("noUseDom");
                break;//"El dominio no está usado en el diseño."

            case RATIFYING_DB:
                texto = _textos.get("ratifyingDB");
                break;//"INICIANDO LA VALIDACIÓN DE LA BASE DE DATOS"
            case RATIFYING_DOMAINS:
                texto = _textos.get("ratifyingDomains");
                break;//"VALIDANDO DOMINIOS"
            case RATIFYING_ATTRIBUTES:
                texto = _textos.get("ratifyingAttributes");
                break;//"VALIDANDO ATRIBUTOS"
            case RATIFYING_ENTITIES:
                texto = _textos.get("ratifyingEntities");
                break;//"VALIDANDO ENTIDADES"
            case RATIFYING_RELATIONS:
                texto = _textos.get("ratifyingRelations");
                break;//"VALIDANDO RELACIONES"
            case RATIFY_SUCCESS:
                texto = _textos.get("ratifySuccess");
                break;//"VALIDACIÓN REALIZADA CON ÉXITO"
            case RATIFY_ERROR:
                texto = _textos.get("ratifyingError");
                break;//"ERROR EN EL PROCESO. VALIDACIÓN INTERRUMPIDA"

            case MUST_RATIFY_MODEL:
                texto = _textos.get("mustRatifyModel");
                break;//"Debe validar satisfactoriamente el modelo antes de generar el script."
            case DESIGN_SQL_CODE:
                texto = _textos.get("designSqlCode");
                break;//"CÓDIGO SQL DEL DISEÑO"
            case MUST_GENERATE_SCRIPT:
                texto = _textos.get("mustGenerateScript");
                break;//"Debe generar el Script SQL antes de exportarlo."
            case SQL_FILES:
                texto = _textos.get("sqlFiles");
                break;//"Ficheros SQL"
            case OK_FILE:
                texto = _textos.get("okFile");
                break;//"Se ha generado satisfactoriamente el fichero."
            case FILE:
                texto = _textos.get("file");
                break;//"Fichero"
            case SCRIPT_ERROR:
                texto = _textos.get("scriptError");
                break;//"Se ha producido un error al volcar el Script en el fichero."
            case SCRIPT_GENERATED_FOR:
                texto = _textos.get("scriptGeneratedFor");
                break;//"El script SQL fue generado para ejecutarse en un DBMS de tipo"
            case CONEXION_TYPE_IS:
                texto = _textos.get("conexionTypeIs");
                break;//"pero el tipo de conexión actual es"
            case POSSIBLE_ERROR_SRIPT:
                texto = _textos.get("possibleErrorScript");
                break;//"Es posible que el script no se ejecute correctamente."
            case SHOULD_GENERATE_SCRIPT:
                texto = _textos.get("shouldGenerateScript");
                break;//"Para evitar este problema, genere de nuevo el script para el tipo"
            case OF_CONEXION:
                texto = _textos.get("ofConexion");
                break;//"de conexión actual."
            case CONTINUE_ANYWAY:
                texto = _textos.get("continueAnyway");
                break;//"¿Desea continuar de todas maneras?"
            case NO_DB_CONEXION:
                texto = _textos.get("noDBConexion");
                break;//"No se pudo abrir una conexión con la base de datos."
            case REASON:
                texto = _textos.get("reason");
                break;//"el motivo es el siguiente"
            case CANT_EXECUTE_SCRIPT:
                texto = _textos.get("cantExecuteScript");
                break;//"No se pudo ejecutar el script."
            case ENQUIRY_ERROR:
                texto = _textos.get("enquiryError");
                break;//"El error se produjo en la consulta"
            case CANT_CLOSE_CONEXION:
                texto = _textos.get("cantCloseConexion");
                break;//"No se pudo cerrar la conexión."
            case OK_SCRIPT_EXECUT:
                texto = _textos.get("okScriptExecut");
                break;//"El script se ha ejecutado correctamente."

            case ANALYSIS:
                texto = _textos.get("analysis");
                break;//"SECCIÓN DE CREACIÓN DE TABLAS"
            case TYPES_SECTION:
                texto = _textos.get("typesSection");
                break;//"SECCIÓN DE CREACIÓN DE TIPOS ENUERADOS"
            case KEYS_SECTION:
                texto = _textos.get("keysSection");
                break;//"SECCIÓN DE ESTABLECIMIENTO DE CLAVES"
            case CONSTRAINTS_SECTION:
                texto = _textos.get("constraintsSection");
                break;

            case MUST_VALIDATE_MODEL:
                texto = _textos.get("mustValidateModel");
                break;//"Debe validar satisfactoriamente el modelo antes de generar el modelo relacional."
            case RELATIONAL_MODEL_GENERATED:
                texto = _textos.get("relationalModelGenerated");
                break;//"MODELO RELACIONAL GENERADO"

            //-----------PERSISTENCIA
            case UNESPECTED_XML_ERROR:
                texto = _textos.get("unespectedXMLerror");
                break;//"Error inesperado en el fichero"
            case ENT_ARITY:
                texto = _textos.get("entArity");
                break;// "Entidad y aridad: ";
            case ROL:
                texto = _textos.get("rol");
                break;//"Rol "
            case ID_ENT:
                texto = _textos.get("idEnt");
                break;//", Id de entidad "

            //--- --- --- GUI--- --- ---
            //GUI_InsertarEntidad
            case INSERT_ENTITY:
                texto = _textos.get("insertNewEntity");
                break;
            case WEAK_ENTITY:
                texto = _textos.get("weakEntity");
                break;
            case WRITE_ENTITY_NAME:
                texto = _textos.get("writeEntityName");
                break;
            case SELECT_STRONG_ENTITY:
                texto = _textos.get("selectStrongEntity");
                break;
            case WRITE_RELATION_WEAK:
                texto = _textos.get("writeRelationWeak");
                break;
            case CREATE_STRONG_ENTITY:
                texto = _textos.get("createStrongEntity");
                break;

            //GUI_InsertarRelacion
            case INSERT_RELATION:
                texto = _textos.get("insertNewRelation");
                break;
            case WRITE_RELATION_NAME:
                texto = _textos.get("writeRelationName");
                break;

            //GUI_AnadirAtributoEntidad y GUI_AnadirAtributoRelacion
            case INSERT_ATTRIBUTE:
                texto = _textos.get("insertNewAttribute");
                break;
            case COMPOSITE_ATTRIBUTE:
                texto = _textos.get("compositeAttribute");
                break;
            case PRIMARY_KEY_ATTRIBUTE:
                texto = _textos.get("primaryKeyAttribute");
                break;
            case NOT_NULL_ATTRIBUTE:
                texto = _textos.get("notNullAttribute");
                break;
            case UNIQUE_ATTRIBUTE:
                texto = _textos.get("uniqueAttribute");
                break;
            case VALUE_ATTRIBUTE:
                texto = _textos.get("valueAttribute");
                break;
            case DOMAIN_ATTRIBUTE:
                texto = _textos.get("domainAttribute");
                break;
            case SIZE_ATTRIBUTE:
                texto = _textos.get("sizeAttribute");
                break;

            //GUI_AnadirSubAtributoAtributo
            case INSERT_NEW_SUBATTRIBUTE:
                texto = _textos.get("insertNewSubAttribute");
                break;

            //GUI_AnadirEntidadARelacion
            case INSERT_NEW_ENTITY_TO_RELATION:
                texto = _textos.get("insertNewEntityToRelation");
                break;
            case IMPOSIBLE_TO_INSERT_ENTITY:
                texto = _textos.get("imposibleToInsertEntity");
                break;
            case NO_ENTITY:
                texto = _textos.get("noEntities");
                break;
            case SELECT_ENTITY:
                texto = _textos.get("selectEntity");
                break;
            case WRITE_NUMBERS_RELATION:
                texto = _textos.get("writeNumbersRelation");
                break;
            case THE:
                texto = _textos.get("the");
                break;
            case TO:
                texto = _textos.get("to");
                break;
            case WRITE_ROLL:
                texto = _textos.get("writeRoll");
                break;
            case LABEL1A1:
                texto = _textos.get("label1a1");
                break;
            case LABEL1AN:
                texto = _textos.get("label1aN");
                break;
            case LABELNAN:
                texto = _textos.get("labelNaN");
                break;

            //GUI_AnadirEntidadHija
            case INSERT_NEW_DAUGTHER:
                texto = _textos.get("insertNewDaughter");
                break;
            case IMPOSIBLE_TO_INSERT_DAUGHTER:
                texto = _textos.get("imposibleToInsertDaughter");
                break;
            case NO_FATHER:
                texto = _textos.get("noFather");
                break;
            case SELECT_ENTITY_DAUTHTER:
                texto = _textos.get("selectEntityDaughter");
                break;
            case NO_ENTITIES_AVAILABLES:
                texto = _textos.get("noEntitiesAvailables");
                break;

            //GUI_ConfigurarConexionDBMS
            case SHAPE_DBMS:
                texto = _textos.get("shapeDBMS");
                break;
            case EXPLANATION_DBMS1:
                texto = _textos.get("explanationDBMS1");
                break;
            case EXPLANATION_DBMS2:
                texto = _textos.get("explanationDBMS2");
                break;
            case EXPLANATION_DBMS3:
                texto = _textos.get("explanationDBMS3");
                break;
            case STRING_CONNECTION:
                texto = _textos.get("stringConnection");
                break;
            case USER:
                texto = _textos.get("user");
                break;
            case PASSWORD:
                texto = _textos.get("password");
                break;
            case INFORMATION_INCOMPLETE:
                texto = _textos.get("informationIncomplete");
                break;
            case DBDT:
                texto = _textos.get("dbdt");
                break;
            case CONNECT:
                texto = _textos.get("connect");
                break;

            //Ventana de GUI_EditarCardinalidadEntidad
            case EDIT_ARITY_AND_ROLLE:
                texto = _textos.get("editArityAndRolle");
                break;
            case IMPOSIBLE_EDIT_ROLLE:
                texto = _textos.get("imposibleToEditRolle");
                break;
            case NO_ENTITIES_IN_RELATION:
                texto = _textos.get("noEntitiesInRelation");
                break;
            case EDIT_ARITY:
                texto = _textos.get("editArity");
                break;
            case SELECT_ENTITY_TO_CHANGE:
                texto = _textos.get("selectEntityToChange");
                break;
            case WRITE_NEW_ARITY:
                texto = _textos.get("writeNewArity");
                break;
            case WRITE_NEW_ROLLE:
                texto = _textos.get("writeNewRolle");
                break;
            case IF_ENTITY_HAS_ROLLE:
                texto = _textos.get("ifEntityHasRolle");
                break;

            //Ventana de GUI_EditarDominioAtributo
            case EDIT_DOMAIN_ATTRIBUTE:
                texto = _textos.get("editDomainAttribute");
                break;
            case IMPOSIBLE_EDIT_DOMAIN:
                texto = _textos.get("imposibleEditDomain");
                break;
            case COMPLEX_ATTRIBUTE:
                texto = _textos.get("complexAttribute");
                break;
            case SELECT_DOMAIN_FOR_ATTRIBUTE:
                texto = _textos.get("selectDomainForAttribute");
                break;

            //Ventana de GUI_EstablcerEntidadPadre
            case SET_PARENT_ENTITY:
                texto = _textos.get("setParentEntity");
                break;
            case IMPOSIBLE_SET_PARENT:
                texto = _textos.get("imposibleSetParent");
                break;
            case OTHER_PARENT:
                texto = _textos.get("otherParent");
                break;
            case IMPOSIBLE_SET_PARENT_IN_ISA:
                texto = _textos.get("imposibleSetParenInISA");
                break;
            case SELECT_PARENT_ENTITY:
                texto = _textos.get("selectParentEntity");
                break;

            //Ventana de GUI_InsertarDominio
            case INSERT_NEW_DOMAIN:
                texto = _textos.get("insertNewDomain");
                break;
            ...
            case EDIT_DOMAIN_GUI:
                texto = _textos.get("editDomain");
                break;
            ...
            case QUIT_ENTITY:
                texto = _textos.get("quitEntity");
                break;
            case IMPOSIBLE_QUIT_ENTITY:
                texto = _textos.get("imposibleQuitEntity");
                break;
            case SELECT_ENTITY_TO_QUIT:
                texto = _textos.get("selectEntityToQuit");
                break;


            //Ventana GUI_QuitarEntidadARelacion
            case QUIT_DAUGHTER_ENTITY:
                texto = _textos.get("quitDaughterEntity");
                break;
            case IMPOSIBLE_QUIT_DAUGHTER_ENTITY:
                texto = _textos.get("imposibleQuitEntityDaughter");
                break;
            case NO_DAUGHTER_ENTITY:
                texto = _textos.get("noDaughterEntity");
                break;
            case SELECT_DAUGHTER_TO_QUIT:
                texto = _textos.get("selectDaughterToQuit");
                break;

            //Ventana GUI_QuitarEntidadPadre
            case QUIT_PARENT_ENTITY:
                texto = _textos.get("quitParentEntity");
                break;
            case EXPLICATION_QUIT_PARENT:
                texto = _textos.get("explicationQuitParent");
                break;
            case DO_YOU_WISH_QUIT_PARENT:
                texto = _textos.get("doYouWhisQuitParent");
                break;
            case IMPOSIBLE_QUIT_PARENT:
                texto = _textos.get("imposibleQuitParent");
                break;

            //Ventana GUI_RenombrarAtributo
            case RENAME_ATTRIBUTE:
                texto = _textos.get("renameAttribute");
                break;
            case WRITE_NAME_ATTRIBUTE_SELECTED:
                texto = _textos.get("writeNameAttributeSelected");
                break;

            //Ventana GUI_RenombrarDominio
            case RENAME_DOMAIN:
                texto = _textos.get("renameDomain");
                break;
            case WRITE_NEW_DOMAIN_NAME:
                texto = _textos.get("writeNewDomainName");
                break;

            //GUI_RenombrarEntidad
            case RENAME_ENTITY_DBDT:
                texto = _textos.get("renameEntityDBCase");
                break;
            case WRITE_NEW_ENTITY_NAME:
                texto = _textos.get("writeNewEntityName");
                break;

            //GUI_RenombrarRelation
            case RENAME_RELATION_DBDT:
                texto = _textos.get("renameRelationDBCase");
                break;
            case EXPLICATION_RENAME_RELATION1:
                texto = _textos.get("explicationRenameRelation1");
                break;

            //GUI_Conexion 33xx
            case SERVER:
                texto = _textos.get("server");
                break;
            case PORT:
                texto = _textos.get("port");
                break;
            case DATA_BASE:
                texto = _textos.get("dataBase");
                break;
            case CREATE_DATA_BASE:
                texto = _textos.get("create");
                break;
            case USER_DATA_BASE:
                texto = _textos.get("user");
                break;
            case PASSWORD_DATA_BASE:
                texto = _textos.get("password");
                break;

            //GUI_SeleccionarConexion
            case SELECT_CONNECTION:
                texto = _textos.get("selectConnection");
                break;

            //Presentacion.Grafo
            case DELETE_ALL_NODES:
                texto = _textos.get("deleteAllNodes");
                break;//"Todos los nodos seleccionados serán eliminados definitivamente del sistema."
            case DBCASE_DELETE:
                texto = _textos.get("dbcaseDelete");
                break;//"DBCASE: Eliminar"
            case NO_ENTITY_INVOLVED:
                texto = _textos.get("noEntityInvolved");
                break;//"No interviene ninguna entidad"
            case PARENT_ENTITY:
                texto = _textos.get("parentEntity");
                break;//"Entidad padre"
            case NO_CHILDS_ENTITIES:
                texto = _textos.get("noChildEntities");
                break;//"No tiene entidades hijas"
            case CHILDREN_ENTITIES:
                texto = _textos.get("childrenEntities");
                break;//"Entidades hijas"
            case IS_MULTIVALUATED:
                texto = _textos.get("isMultivaluated");
                break;//"Es un atributo multivalorado"
            case IS_NOT_NULL:
                texto = _textos.get("isNotNull");
                break;//	"Es un atributo no nulo"
            case IS_UNIQUE:
                texto = _textos.get("isUnique");
                break;//	"Es un atributo único"
            case IS_COMPOSED:
                texto = _textos.get("isComposed");
                break;//	"Es un atributo compuesto"
            case NO_COMPONENTS:
                texto = _textos.get("noComponents");
                break;//	"No tiene componentes"
            case COMPONENTS:
                texto = _textos.get("components");
                break;//	"Componentes"
            case IS_WEAK_ENT:
                texto = _textos.get("isWeakEnt");
                break;//	"Es una entidad debil"
            case ADD_ENTITY:
                texto = _textos.get("addEntity");
                break;//"Insertar una nueva entidad"
            case ADD_RELATION:
                texto = _textos.get("addRelation");
                break;//"Insertar una nueva relación"
            case ADD_ISARELATION:
                texto = _textos.get("addIsaRelation");
                break;//"Insertar una nueva relación IsA"
            case ADD_DOMAIN:
                texto = _textos.get("addDomain");
                break;//"Crear un nuevo dominio"
            case RENAME_ENTITY:
                texto = _textos.get("renameEntity");
                break;//"Renombrar la entidad"
            case ADD_ATTRIBUTE:
                texto = _textos.get("addAttribute");
                break;//"Añadir un nuevo atributo"
            case DELETE_ENT:
                texto = _textos.get("deleteEnt");
                break;//"Eliminar la entidad"
            case RENAME_ATTRIB:
                texto = _textos.get("renameAttrib");
                break;//"Renombrar el atributo"
            case EDIT_DOMAIN:
                texto = _textos.get("editDomain");
                break;//"Editar el dominio"
            case ADD_SUBATTRIBUTE:
                texto = _textos.get("addSubAttribute");
                break;//"Añadir un subatributo"
            case NOT_NULL:
                texto = _textos.get("notNull");
                break;//"Not Null"
            case UNIQUE:
                texto = _textos.get("Unique");
                break;//"Unique"
            case IS_PRIMARY_KEY:
                texto = _textos.get("isPrimaryKey");
                break;//"Es clave primaria de la entidad"
            case DELETE_ATTRIB:
                texto = _textos.get("deleteAttrib");
                break;//"Eliminar el atributo"
            case SET_PARENT_ENT:
                texto = _textos.get("setParentEnt");
                break;//"Establecer entidad padre"
            case REMOVE_PARENT_ENT:
                texto = _textos.get("removeParentEnt");
                break;//"Quitar entidad padre"
            case ADD_CHILD_ENT:
                texto = _textos.get("addChilEnt");
                break;//"Añadir entidad hija"
            case REMOVE_CHILD_ENT:
                texto = _textos.get("removeChildEnt");
                break;//	"Quitar entidad hija"
            case DELETE_REL:
                texto = _textos.get("deleteRel");
                break;//"Eliminar la relación"
            case RENAME_RELATION:
                texto = _textos.get("renameRelation");
                break;//	"Renombrar la relación"
            case ADD_ENT:
                texto = _textos.get("addEnt");
                break;//	"Añadir una entidad"
            case REMOVE_ENTITY:
                texto = _textos.get("removeEntity");
                break;//	"Quitar una entidad"
            case EDIT_CARD_ROL:
                texto = _textos.get("editCardRol");
                break;//	"Editar la cardinalidad o el rol de una entidad"

            // GUIPrincipal + utilidades.AccionMenu
            case DOM_MENU_RENAME:
                texto = _textos.get("domMenuRename");
                break;//"Renombrar"
            case DOM_MENU_DELETE:
                texto = _textos.get("domMenuDelete");
                break;//"Eliminar"
            case DOM_MENU_MODIFY:
                texto = _textos.get("domMenuModify");
                break;//"Modificar dominio"
            case DOM_MENU_ADD:
                texto = _textos.get("domMenuAdd");
                break;//"Añadir nuevo dominio"
            case DOM_MENU_IN_ORDER:
                texto = _textos.get("domMenuRenameInOrder");
                break;//"Ordenar valores"
            case DOM_TREE_CREATED_DOMS:
                texto = _textos.get("domTreeCreatedDoms");
                break;//"Dominios creados"
            case DOM_TREE_TYPE:
                texto = _textos.get("domTreeTypes");
                break;//"tipo base"
            case DOM_TREE_VALUES:
                texto = _textos.get("domTreeValues");
                break;//"Valores"

            case DB_CASE_TOOL:
                texto = _textos.get("dbCaseTool");
                break;
            case TOOL_FOR_DESING:
                texto = _textos.get("toolForDesing");
                break;
            case SS_II:
                texto = _textos.get("ssii");
                break;
            case COLLEGE:
                texto = _textos.get("college");
                break;
            case UNIVERSITY:
                texto = _textos.get("university");
                break;
            case DIRECTOR:
                texto = _textos.get("director");
                break;
            case TEACHER_NAME:
                texto = _textos.get("teacherName");
                break;
            case AUTHORS:
                texto = _textos.get("authors");
                break;
            case AUTHOR1:
                texto = _textos.get("author1");
                break;
            case AUTHOR2:
                texto = _textos.get("author2");
                break;
            case AUTHOR3:
                texto = _textos.get("author3");
                break;
            case BASED:
                texto = _textos.get("based");
                break;
            case CONTACT:
                texto = _textos.get("contact");
                break;
            case DBCASE_LABEL:
                texto = _textos.get("dbcaseLabel");
                break;

            case SYSTEM:
                texto = _textos.get("system");
                break;//"Sistema"
            case EXIT_MINCASE:
                texto = _textos.get("exitMincase");
                break;//"Salir"
            case OPTIONS:
                texto = _textos.get("options");
                break;//"Opciones"
            case CURRENT_DBMS:
                texto = _textos.get("currentDBMS");
                break;//"Gestor de Base de Datos actual"
            case SELECT_LANGUAGE:
                texto = _textos.get("selectLanguage");
                break; // "Lenguaje"
            case EXPORT_DIAGRAM:
                texto = _textos.get("exportDiagram");
                break;//"Exportar el diagrama E/R como archivo de imagen"
            case PRINT_DIAGRAM:
                texto = _textos.get("printDiagram");
                break;//"Imprimir el diagrama E/R"
            case HELP:
                texto = _textos.get("help");
                break;//"Ayuda"
            case CONTENTS:
                texto = _textos.get("contents");
                break;//"Contenidos"
            case ABOUT:
                texto = _textos.get("about");
                break;//"Acerca de DBDT"
            case ER_MODEL:
                texto = _textos.get("erModel");
                break;//"Diagrama Entidad Relación"
            case CONC_MODEL:
                texto = _textos.get("concModel");
                break;//"Esquema Conceptual"
            case LOGIC_MODEL:
                texto = _textos.get("logicModel");
                break;//"Esquema Logico"
            case PHYS_MODEL:
                texto = _textos.get("physicModel");
                break;//"Esquema Físico"
            case INF_PANEL:
                texto = _textos.get("infPanel");
                break;//"Panel de información"
            case DOM_PANEL:
                texto = _textos.get("domPanel");
                break;//"Panel dominios"
            case GRAPH_PANEL:
                texto = _textos.get("graphPanel");
                break;//"Panel grafo"
            case EVENT_PANEL:
                texto = _textos.get("eventPanel");
                break;//"Panel de sucesos"
            case SHOW_EVENTS_PANEL:
                texto = _textos.get("showEventsPanel");
                break;//"Panel de sucesos"
            case CODE_GENERATION:
                texto = _textos.get("codeGeneration");
                break;//"Generación de código"
            case CLEAN:
                texto = _textos.get("clean");
                break;//"Limpiar el area de texto"
            case VALIDATE_DESIGN:
                texto = _textos.get("validateDesign");
                break;//"Validar el diseño realizado"
            case GENERATE_REL_MODEL:
                texto = _textos.get("generateRelModel");
                break;//"Generar el Modelo Relacional del diseño realizado"
            case GENERATE_SQL_CODE:
                texto = _textos.get("generateSQLmodel");
                break;//"Generar el código SQL del diseño realizado"
            case EXPORT_SQL_FILE:
                texto = _textos.get("exportSQLfile");
                break;//"Exportar el Script SQL a un archivo"
            case EXECUTE_SCRIPT:
                texto = _textos.get("executeScript");
                break;//"Ejecutar el script SQL en un DBMS"
            case MUST_GENERATE_SCRIPT_EX:
                texto = _textos.get("mustGenerateScriptEx");
                break;//"Debe generar el Script SQL antes de ejecutarlo."
            case JPEG_FILES:
                texto = _textos.get("jpegFiles");
                break;//"Ficheros JPEG"
            case OK_EXPORT:
                texto = _textos.get("okExport");
                break;//"Se ha exportado satisfactoriamente el diagrama al fichero"

            case NO_CONECTOR:
                texto = _textos.get("noConector");
                break;//"Error: No se encuentra el conector JDBC"
            case TABLE_TITLE:
                texto = _textos.get("tableTitle");
                break;
            case TEST_DATA:
                texto = _textos.get("testData");
                break;
            case CLEAN_FIELDS:
                texto = _textos.get("cleanFields");
                break;
            case HINT:
                texto = _textos.get("hint");
                break;
            case EXPLORE:
                texto = _textos.get("explore");
                break;
            case EXISTING_CONN:
                texto = _textos.get("existingConns");
                break;
            case CHOOSE_CONN:
                texto = _textos.get("chooseConn");
                break;

            case RESTRICTIONS:
                texto = _textos.get("restrictions");
                break;
            case ADD_RESTRICTIONS:
                texto = _textos.get("addRestrictions");
                break;
            case TABLE_UNIQUE:
                texto = _textos.get("tableUnique");
                break;
            case ADD_UNIQUE:
                texto = _textos.get("addUnique");
                break;
            case UNIQUE_ERROR:
                texto = _textos.get("uniqueError");
                break;
            case ERROR_TABLE:
                texto = _textos.get("errorTable");
                break;
            case THEME:
                texto = _textos.get("theme");
                break;
            case GENERATE:
                texto = _textos.get("generate");
                break;
            case ELEMENTS:
                texto = _textos.get("elements");
                break;
            case VIEW:
                texto = _textos.get("view");
                break;
            case TABLE:
                texto = _textos.get("table");
                break;
            case VOLUME:
                texto = _textos.get("volume");
                break;
            case FREQ:
                texto = _textos.get("freq");
                break;
            case CANDIDATE_KEYS:
                texto = _textos.get("candidateKeys");
                break;
            case TABLE_CONSTR:
                texto = _textos.get("tableconstraints");
                break;
            case RELATIONS:
                texto = _textos.get("relations");
                break;
            case RIC:
                texto = _textos.get("ric");
                break;
            case LOST_CONSTR:
                texto = _textos.get("lostConstr");
                break;
            case THE_ATRIBUTE:
                texto = _textos.get("theattribute");
                break;
            case THE_RELATION:
                texto = _textos.get("therelation");
                break;
            case THE_ENTITY:
                texto = _textos.get("theentity");
                break;
            case THE_DOMAIN:
                texto = _textos.get("thedomain");
                break;
            case EMPTY_DIAGRAM:
                texto = _textos.get("emptyDiagram");
                break;
            case SCRIPT_GENERATED:
                texto = _textos.get("scriptGenerated");
                break;
            case SYNTAX:
                texto = _textos.get("syntax");
                break;
            case BASED1:
                texto = _textos.get("based1");
                break;
            case BASED1A1:
                texto = _textos.get("based1a1");
                break;
            case BASED1A2:
                texto = _textos.get("based1a2");
                break;
            case BASED1A3:
                texto = _textos.get("based1a3");
                break;
            case BASED2:
                texto = _textos.get("based2");
                break;
            case BASED2A1:
                texto = _textos.get("based2a1");
                break;
            case BASED2A2:
                texto = _textos.get("based2a2");
                break;
            case BASED2A3:
                texto = _textos.get("based2a3");
                break;
            case BASED2P:
                texto = _textos.get("based2p");
                break;
            case AUTHOR:
                texto = _textos.get("author");
                break;
            case TABLES:
                texto = _textos.get("tables");
                break;
            case NULLATTR:
                texto = _textos.get("nullableAttr");
                break;
            case PART_TOTAL:
                texto = _textos.get("partTotal");
                break;
            case CARDMINDE:
                texto = _textos.get("cardMinde");
                break;
            case YCARDMINDE:
                texto = _textos.get("yCardMinde");
                break;
            case CARDMAXDE:
                texto = _textos.get("cardMaxde");
                break;
            case YCARDMAXDE:
                texto = _textos.get("yCardMaxde");
                break;
            case YMAXDE:
                texto = _textos.get("yMaxde");
                break;
            case OF:
                texto = _textos.get("of");
                break;
            case FOR:
                texto = _textos.get("for");
                break;
            default:
                texto = Lenguaje.notExistingMessage;
        }
