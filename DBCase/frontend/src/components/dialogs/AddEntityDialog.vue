...
<template>
    ...
    >
        <div class="flex flex-col gap-3">
            ...
            <InputText id="entityName" v-model="entityName" :placeholder="t('entity.enterEntityName')" autofocus />
            ...
            <template v-if="isWeakEntity">
                <label for="relationName" class="font-semibold mt-2">{{ t('entity.weakRelationshipName') }}</label>
                <InputText id="relationName" v-model="relationName" :placeholder="t('entity.enterRelationName')" />
        ...
        <template #footer>
            <Button :label="t('common.cancel')" icon="bi bi-x-lg" severity="secondary" @click="visible = false" />
