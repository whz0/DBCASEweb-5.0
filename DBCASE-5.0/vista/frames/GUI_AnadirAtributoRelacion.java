...
public class GUI_AnadirAtributoRelacion extends Parent_GUI {
    ...
    private final JTextField cajaNombre = this.getCajaNombre(25, 45);
    ...
    private void initComponents() {
        ...
        cajaNombre.addKeyListener(new KeyListener() {
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == 10) {
                    botonAnadirActionPerformed(null);
                }
            }
    ...
    private void botonAnadirActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            if (this.opcionCompuesto.isSelected()) {
                ...
                ta.setUnique(false);//en caso de ser Unique se hace la llamada abajo.
                ...
                if (!(dominio.equals(TipoDominio.CHAR) ||
                        dominio.equals(TipoDominio.VARCHAR) ||
                        dominio.equals(TipoDominio.TEXT) ||
                        dominio.equals(TipoDominio.INTEGER) ||
                        dominio.equals(TipoDominio.DECIMAL) ||
                        dominio.equals(TipoDominio.FLOAT))) {
    ...
    private final KeyListener general = new KeyListener() {
        public void keyPressed(KeyEvent e) {
            if (e.getKeyCode() == 10) {
                botonAnadirActionPerformed(null);
            }
    ...
    private final Runnable doFocus = new Runnable() {
        public void run() {
    ...
    private JCheckBox getOpcionCompuesto() {
        if (opcionCompuesto == null) {
            ...
            opcionCompuesto.setBounds(25, 80, 220, 18);
            ...
            opcionCompuesto.addKeyListener(new KeyListener() {
                public void keyPressed(KeyEvent e) {
                    if (e.getKeyCode() == 10) {
                        opcionCompuesto.setSelected(!opcionCompuesto.isSelected());
                    }
                }
    ...
    private JCheckBox getOpcionUnique() {
        if (opcionUnique == null) {
            ...
            opcionUnique.setBounds(25, 120, 220, 18);
    ...
    private JCheckBox getOpcionMultivalorado() {
        if (opcionMultivalorado == null) {
            ...
            opcionMultivalorado.setBounds(25, 140, 221, 18);
        ...
        opcionMultivalorado.addKeyListener(new KeyListener() {
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == 10) {
                    opcionMultivalorado.setSelected(
