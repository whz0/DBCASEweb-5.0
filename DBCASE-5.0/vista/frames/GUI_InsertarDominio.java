...
public class GUI_InsertarDominio extends Parent_GUI {
    ...
    private final JTextField cajaNombre = this.getCajaNombre(25, 40);
    ...
    private void initComponents() {
        ...
        }
        {
            ...
            if (items.length - (i + 1) >= 0) System.arraycopy(items, i + 1, items2, i + 1 - 1, items.length - (i + 1));
